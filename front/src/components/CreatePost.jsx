                    ...
                    <div className="col-lg-6">
                        <form onSubmit={this.sendPost}>
                            <div className="form-group">
                                ...
                                <input onChange={this.handleInputChange} type="text" className="form-control" id="title" placeholder="enter post title"/>
                            </div>
                            <div className="form-group">
                                <label htmlFor="text">Text</label>
                                <textarea onChange={this.handleInputChange} className="form-control" id="text" rows="3" placeholder="enter post text">
                                </textarea>
                            </div>
